                ...
                <div class="row mt-4">
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            <div class="item-img" v-if="blocks?.media?.directus_files_id?.filename_disk">
                                <img loading="lazy" :src="`${$directus.url}assets/${blocks?.media?.[0]?.directus_files_id?.filename_disk}`" :alt="blocks?.name" />
                            </div>
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            <div class="item-img" v-if="blocks?.media?.directus_files_id?.filename_disk">
                                <img loading="lazy" :src="`${$directus.url}assets/${blocks?.media?.[1]?.directus_files_id?.filename_disk}`" :alt="blocks?.name" />
                            </div>
                    ...
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            <div class="item-img" v-if="blocks?.media?.directus_files_id?.filename_disk">
                                <img loading="lazy" :src="`${$directus.url}assets/${blocks?.media?.[2]?.directus_files_id?.filename_disk}`" :alt="blocks?.name" />
                            </div>
