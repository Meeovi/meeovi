<template>
    <div>
        <section class="info3 cid-shUV3zM5v2" id="info3-0">
            ...
            <div class="card-wrapper">
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style align-center mb-4 display-1">
                        <strong>Meeovi News</strong></h4>
                    <p class="mbr-text mbr-fonts-style mb-4 display-7">
                        News from all over the world</p>
...
<section class="content2 cid-shUV7cf9PD" id="content2-1">
