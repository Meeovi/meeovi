...
import { ssrRenderAttrs } from 'file://C:/Users/Basti/OneDrive/Documents/My%20Websites/Handmade%20Sites/Javascript-Projects/Nuxt-Projects/AlternateCMS-Framework/TheMeeoviCompany-Sites/bold-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><section class="mbr-section article content10 cid-rp3OJGc3PS" id="content10-9"><div class="container"><div class="inner-container"><h5>Terms and Conditions</h5><hr class="line"><div class="align-center mbr-fonts-style"> Mobirise is one of the easiest website development tools available today. It also gives you the freedom to develop as many websites as you like given the fact that it is a desktop app. </div><hr class="line"></div></div></section></div>`);
    };
  }
});
...
//# sourceMappingURL=terms.b04f3f95.mjs.map
