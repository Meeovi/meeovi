<template>
    <div>
        <section class="mbr-section content5 cid-tyE0LA0Ewz" id="content5-23">
        ...
        <section class="services4 cid-tyE0Gm2xJx" id="services4-22">
            <!---->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-5 col-lg-4">
                                        <div class="wrapper border_wrapper">
                                            <!--Cost-->
                                            <p
                                                class="mbr-text mbr-fonts-style col-right mbr-black align-center display-2">
                                                $990
                                            </p>
                                            <!--Btn-->
