// Run this with: node packages/nuxt-magento/scripts/run-smoke.js
const { normalizeProduct, normalizeCart, normalizeCustomer } = require('./smoke/normalizers')

console.log('Running nuxt-magento smoke-runner (no installs)...')

// Sample GraphQL-like payloads
const sampleProduct = {
  id: 1,
  sku: 'SKU-001',
  name: 'Smoke Product',
